				...
				<div class="row">
					<div class="col-md-12" style="padding-left: 5%;">
						<ul class="button-inline">
							...
							<li>
								<div class="select top_input">
									<select name="playdate" id="playdate" onchange="changedate(this.value);">
										<option value="">Select Day</option>
										<option value="0">Today (<?php echo date("Y-m-d")?>)</option>
										<option value="1">Yesterday (<?php echo date("Y-m-d",strtotime("-1 days"))?>) </option>
										<option value="7">One Week (From <?php echo date("Y-m-d")?> to <?php echo date("Y-m-d",strtotime("-7 days"))?>) </option>
										<option value="15">15 days (From <?php echo date("Y-m-d")?> to <?php echo date("Y-m-d",strtotime("-15 days"))?>) </option>
									</select>
								</div>
							</li>
							<!-- <li>
...
{	 
	...
	var playdate=($("#playdate option:selected").val()) ? $("#playdate option:selected").val(): '';
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+ city_name+"&classid="+classid+"&schoolid="+schoolid+"&subchapterid="+subchapterid+"&playdate="+playdate,
		beforeSend: function() {
...
function changeBoardName()
{
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+state_id+"&classid="+classid+"&schoolid="+schoolid+"&subchapterid="+subchapterid+"&city_id="+city_id+"&playdate="+playdate,
		beforeSend: function() {
			$('#userresult').html("<img src='images/pleasewait.gif' height='80'>").show('fast');	
		},
		success:function(response){
...
function changeBoard(board) {
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+state_id+"&classid="+classid+"&schoolid="+schoolid+"&subchapterid="+subchapterid+"&board_id="+board+"&city_id="+city+"&chapter_id="+chapter_id+"&playdate="+playdate,
		beforeSend: function() {
			$('#userresult').html("<img src='images/pleasewait.gif' height='80'>").show('fast');	
		},
		success:function(response){
...
function changeSubject(subject){
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+state_id+"&classid="+classid+"&schoolid="+schoolid+"&subtopicid="+subtopic+"&board_id="+board_id+"&city_id="+city_id+"&chapter_id="+chapter_id+"&subject_id="+subject+"&playdate="+playdate,
		beforeSend: function() {
...
var playdate=($("#playdate option:selected").val()) ? $("#playdate option:selected").val(): '';
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+state_id+"&classid="+classid+"&schoolid="+schoolid+"&subchapterid="+subchapterid+"&board_id="+board_id+"&city_id="+city_id+"&chapter_id="+chapter_id+"&playdate="+playdate,
		beforeSend: function() {
			$('#userresult').html("<img src='images/pleasewait.gif' height='80'>").show('fast');	
		},
		success:function(response){
...
/* ---+-----+---- Get user result list with date ---+---+--*/ 
...
function changedate(){
	...
	$.ajax({
		...
		cache:false,
		url:"process/postaction.php",
		data: "action=getList&state_id="+state_id+"&classid="+classid+"&schoolid="+schoolid+"&subtopicid="+subtopic+"&board_id="+board_id+"&city_id="+city_id+"&chapter_id="+chapter_id+"&playdate="+playdate,
		beforeSend: function() {
			$('#userresult').html("<img src='images/pleasewait.gif' height='80'>").show('fast');	
		},
		success:function(response){
