...
class  Download
{
	...
	public function getuserResult($state_id,$city_id,$board_id,$schoolid,$classid){
		
	global $conn;

		$sql ="SELECT  kct.`userID`,u.userID, u.name AS student_name,usd.school,usd.grade_id FROM `knowledgekombat_chapter_time` kct
		...
		if (!empty($classid)) $sql .= " AND usd.grade_id = '$classid'";
