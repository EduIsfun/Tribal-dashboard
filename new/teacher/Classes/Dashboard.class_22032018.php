...
class Dashboard
{
	...
	function getskillResult($chapterid){
		global $conn;
		$query = "SELECT chapterID ,skillID FROM knowledgekombat_skill WHERE chapterID='$chapterid'";
		$result = mysqli_query($conn,$query);
		return $result;
	}
