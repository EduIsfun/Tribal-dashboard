...
class  Teacher
{
	...
	public function getoverallGradeNew($subtopicid,$subject_id, $user_ids = '', $grade = '') {


		global $conn;

		$subQuery = " SELECT  AVG(ksa.learningCurrency) as currency, ksa.userID, ksa.created_timestamp, ksa.skillID  FROM knowledgekombat_skill_attempt ksa use index (userID_3) ";
		...
		$query= " select  t.currency  AS currency, t.userID as userid from ( ";
		$query .= $subQuery . $where . $groupby . $orderby ;
		$query .= " ) t  ";
