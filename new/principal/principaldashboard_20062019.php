	...
	<div class="container-fluid"> 
		<div class="row">
			...
			<div class="col-md-4 logo">
				<?php if ($schoollogo!=''){	?>
				<img src="images/<?php echo $schoollogo;?>"> 
				<?php } ?>
		...
		<div class="col-md-7 no-padd">
			...
			<?php	
				...
				if (isset($schoolname)){
					...
					<div class="box-tools">
							<a href="download-report.php?state_id='.$_POST['state_id'].'&city_id='.$city_id.'&schoolname='.$schoolname.'&classid='.$classid.'&subject_id=1" class="btn btn-success button-loading pull-right" 
