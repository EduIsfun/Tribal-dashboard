...
if (isset($_REQUEST['action']) && ($_REQUEST['action']=="getList")){
    ...
    <div class="">';
	$is = 1;
	$globalresult = $teacher->getglobalrankResultNew($gradeid,$schoolname,$city_id,$chapter_id,$subtopic,$subject_id);	
	...
	if(mysqli_num_rows($user)>0){
		...
		$overallresult = $teacher->getrankuserResult($gradeid,$schoolname,$city_id,$chapter_id,$subtopic,$subject_id, $imploded);
