<?php 
		...
		function outputCSV($data) {
			...
			fclose($outstream);
					...
					$resultskill = $dashboard->getskillResult($chapter_id);
						...
						while($rowskill = mysqli_fetch_object($resultskill)){
							...
							$resultlearningaverage = $dashboard->getlearningResultAverage($state_id,$city_id,$school_id,$classid,$skillid,$subject_id,$chapter_id);
			...
			$user = $dashboard->getuserResult($chapter_id,$school_id,$classid,$subject_id,$state_id,$city_id);
				...
				$field_name = $studentName .','.$showall .','. $showoverall .',' . $studentMobile .',' . $studentEmail .','; 
