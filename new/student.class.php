<?php
  class student {
	...
	function updateProfile($objusers,$userid)
		{
			global $conn;
			echo $query = "UPDATE user SET name='".$objusers->name."',email='".$objusers->email."',mobile='".$objusers->mobile."'
,city='".$objusers->city."',country='".$objusers->country."',dob='".$objusers->dob."' WHERE userID='$userid' ";
			$result = mysqli_query($conn,$query);
