...
session_start();
  //error_reporting(0);
   ...
   header('Content-Disposition: attachment;filename=Natural II.csv');

	 $select_table="SELECT c.chapterID AS ChapterID,k.userid AS UserID,c.chapter AS Chapter,u.name AS Name,sc.grade AS Grade FROM chapter c 
