 ...
 session_start();
  ...
  function __autoload($classname){
	...
	if(isset($_POST['action']) && $_POST['action']=="ViewDetails")
	{
		...
		$query= "SELECT i.UserID,i.name,i.mobile,i.emailid,i.time_stamp,u.dob,u.country,u.`created_timestamp`,u.`updated_timestamp`,u.city,u.type,u.countrycode FROM invite_friends i
            INNER JOIN `user` u ON i.UserID=u.userID where i.UserID='$uid'";
...
.dataTables_paginate {
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
           <div class="box-header with-border">
					  <h3 class="box-title"> Invite Friends List</h3>

					  <div class="box-tools pull-right">
							<a href="download-invite.php" class="btn btn-primary pull-right">Export Records</a>
					  </div>
					</div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					  <?php
						 $friendlist = $userdata->getinviteFriends();
						    if($friendlist){
							    $count=1;
						    } 									
						     while($obj= mysqli_fetch_object($friendlist))
						     {
						?>  
                       <tr>
	...
	<div id="orderDetail" class="modal fade">
      ...
      <div class="modal-header" style="background:lightblue">
        ...
        <h4 class="modal-title">Invite Friends Details</h4>
        </div>
