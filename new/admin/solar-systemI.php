        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary" style="margin-top:20px;">
           <div class="box-header with-border">
					  <h3 class="box-title">Solar System I List</h3>

					   <div class="box-tools pull-right">
						 <a href="download-solarI.php" class="btn btn-primary button-loading pull-right" >Export Record</a>
					  </div>
					</div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					  <?php
					  $stuinfo = $userdata->getsolarSystemI();
						    if($stuinfo){
							    $count=1;
						    } 									
